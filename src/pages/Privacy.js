  ...
  return (
    <>
      ...
      <P>
        ...
        Nord-de-l’île-de-Montréal ainsi que de l’Est-de-l’île-de-Montréal ( ou{' '}
        <b>«&nbsp;nous&nbsp;»</b>) accordent une grande importance à la
        protection de vos renseignements personnels ainsi que votre vie privée
        et tient à ce que votre expérience avec elle et avec la plateforme MEPP
        (le <b>«&nbsp;Service&nbsp;»</b>) soit la plus satisfaisante et la plus
        sécuritaire possible. Vous comprenez qu’en utilisant le Service, le
        Service vous sera distribué par MEPP et que les renseignements
        personnels que vous pourriez nous fournir pourront être utilisés pour
        les fins indiquées aux présentes. Aux fins de la présente politique de
        protection des renseignements personnels (la
        <b>«&nbsp;Politique&nbsp;»</b>), l’expression{' '}
        <b>«&nbsp;Renseignements personnels&nbsp;»</b> signifie toute
        information se rapportant à une personne physique identifiée ou
      ...
      <P>
        ...
        paralysie faciale (que nous appelons un{' '}
        <b>«&nbsp;Bénéficiaire&nbsp;»</b> aux fins de la présente Politique).
        Dans ce cadre, le Service permet également à l’équipe de chercheurs de
        l’UdeM (les <b>«&nbsp;Chercheurs&nbsp;»</b>) d’amasser des données
        qualitatives et quantitatives de même que des statistiques générées
        automatiquement par suite de l’utilisation du Service.
      </P>
      <P>
        ...
        contact et gérer leurs rééducations faciales.{' '}
        <b>
          Vous reconnaissez que vous êtes responsable, à titre de clinicien, de
          recueillir un consentement libre et éclairé du Bénéficiaire à la
          collecte des informations quantitatives et qualitatives le concernant.
        </b>
      </P>
      <P>
        ...
        <b>
          Veuillez noter que ces informations ne sont pas transmises aux
      ...
      <P>
        ...
        désignées les <b>«&nbsp;Données&nbsp;»</b>). Les Données ainsi
        transmises sont enregistrées sur les serveurs du Service et pourront
        être accessibles aux Chercheurs.
      </P>
      ...
      <P>
        ...
        tiers, pour les finalités mentionnées à la section{' '}
        <b>«&nbsp;TÉMOINS (COOKIES) ET AUTRES TECHNOLOGIES SIMILAIRES&nbsp;»</b>{' '}
        de la présente Politique. La base juridique de ce traitement est votre
        consentement. Vous pouvez retirer votre consentement à tout moment en
        communiquant avec l’administrateur dont les coordonnées apparaissent au
        bas de la présente Politique. Soyez par ailleurs assurés que nous
        n’associons aucun identifiant de témoins ou de technologies similaires à
        des informations relatives à votre origine raciale ou ethnique, vos
        opinions politiques, vos convictions religieuses ou philosophiques ou
        votre appartenance syndicale, votre santé, votre vie sexuelle ou votre
        orientation sexuelle ni à vos données génétiques ou biométriques qui
        pourraient permettre votre identification de manière unique.
      </P>
      ...
      <P>
        ...
        cette Politique, nous modifierons la date de la{' '}
        <b>«&nbsp;Dernière mise à jour&nbsp;»</b>
      ...
      <P>
        <b>
          Pour toute question ou commentaire concernant cette Politique,
          n’hésitez pas à entrer en contact avec l’administrateur&bnsp;:
        </b>
      </P>
      <P>
        Sarah Martineau
...
const PrivacyEn = ({ t }) => {
  return (
    <>
      ...
      <P>
        The MEPP team, the University of Montreal, the CIUSSS of North Montreal
        Island as well as of the East Montreal Island (or <b>“we”</b>) the
        protection of your personal data as well as your privacy greatly matter
        so us and we want your experience with us and the MEPP platform (the{' '}
        <b>“Service”</b>) to be as satisfactory and as safe as possible. You
        understand that by using the Service, the Service will be provided to
        you by MEPP and that the personal data that you may provide us may be
        used for the purposes specified in this document.
      </P>
      <P>
        For the purpose of this personal data protection policy (the{' '}
        <b>“Policy”</b>), the expression <b>“Personal data“</b> means any
        information pertaining to a physical person who is identified or
        identifiable. An identifiable person is a person who can be identified,
        directly or indirectly, by reference to one or several specific
        elements, particular to their physical, physiologic, genetic,
        psychologic, economic, cultural, or social identity.
      </P>
      <P>
        This policy informs you about i) the types of personal data that we
        process through the Service, ii) the purposes of the processing and the
        legal basis of such processing and iii) the duration this personal data
        is kept. This Policy also informs you on the categories of persons wo
        whom we may transmit your personal Data and in which circumstances we
        may do so Additionally, you will find the rights pertaining to your
        personal Data that you may practice with us. We will only process your
        personal Data on the contractual basis of this Policy.
      </P>
      <P>
        We adjust our practice in matters of respect of personal Data all the
        time for them to always comply with the principles of the{' '}
        <i>Law on personal data and electronic documents protection</i>{' '}
        (Canada), of the <i>Law on the personal data in the private sector</i>{' '}
        (Quebec) and of any other similar applicable law.
      </P>

      <H5>1. CATEGORY OF PERSONAL DATA THAT WE PROCESS</H5>

      <H6>The personal Data that we process when you create your account</H6>
      <P>
        When your account is created, you must provide us the following personal
        Data: your first name, your last name, your email address, a password of
        your choice and the side of your facial paralysis.
      </P>

      <H6>Purposes and legal bases of the processing</H6>
      <P>
        We process your first name, last name, email address and password
        because you must use them to create your account. The legal basis of
        this processing is our legitimate interest in securing your account and
        to identify you in case of reinitialization of your password.
      </P>
      <P>
        We also process your email address to send you important messages about
        the Service, such as messages pertaining to the security of the Service
        and the update of this Policy. The legal basis of this processing is our
        legitimate interest to send you important information pertaining to the
        safety or any important information pertaining to the Service or to
        modifications of this Policy.
      </P>
      <P>
        If you agreed to receive communications from us, we will also process
        your Email address to send you such information about us or the Service.
        The legal basis of this processing is your consent. You can withdraw
        your consent at any time by contacting the administrator of the MEPP,
        whose contact information appear below, or by clicking on the consent
        withdrawal link at the bottom of our emails.
      </P>
      ...
      <P>
        The main function of the Service is to provide you, a clinician, and a
        person suffering from facial paralysis (who we call a{' '}
        <b>“Beneficiary”</b> for the purpose of this Policy) with a reeducation
        platform a facial reeducation platform. In this framework, the Service
        also allows the researchers team of UdeM (the “Researchers”) to collect
        qualitative and quantitative data as well as statistics automatically
        generated following the use of the Service.
      </P>
      <P>
        During your use of the Service, you can use an interface allowing you to
        create a facial reeducation, which will be used for you to make a list
        of Beneficiaries with whom you are in contact and manage their facial
        reeducations.{' '}
        <b>
          You acknowledge that you are responsible, as a clinician, for
          collecting a free and enlightened consent from the Beneficiary to
          collect quantitative and qualitative data pertaining to them
        </b>
        .
      </P>
      <P>
        Please note that you do not have to identify a Beneficiary or provide
        personal Data pertaining to them when you create the file for this
        Beneficiary in your intervention space and that you are free to use a
        pseudonym instead.{' '}
        <b>
          Please note that this data is not transmitted to the Researchers; in
          fact, the file of each Beneficiary is associated with a random number
          and Researchers only have access to this identifier
        </b>
        .
      </P>
      <P>
        For each exercise session, the website will automatically generate a
        certain number of statistics in relation with the use of the website
        (this qualitative, quantitative, and statistical data is collectively
        designated the <b>“Data”</b>). The Data transmitted is saved on the
        servers of the Service and can be accessed by the Researchers.
      </P>

      <H6>Purposes and legal basis of the processing</H6>
      <P>
        We process the Data transmitted to us during your use of the Service to
        make them accessible to the Researchers for them to be used for research
        purposes. The legal basis of this processing is the consent obtained
      ...
      <P>
        ...
        If this consent were to be withdrawn by the Beneficiary, you must then
        stop using the Service in relation to this Beneficiary.
      </P>

      <H6>Cookies and other similar technologies</H6>
      <P>
        Some cookies and other similar technologies may constitute personal Data
        in your regard. We process such indicators and similar technologies to
        track the activities on the Service and retain certain information to
        improve the Service and the global experience during the use of the
        Service.
      </P>

      <H6>Purposes and legal basis of the processing</H6>
      <P>
        If you consented to the collection of information through the cookies
        and other similar technologies, we will process these indicators and
        other similar technologies with the help of third party analytical
        services, for the purpose mentioned in the “COOKIES AND OTHER SIMILAR
        TECHNOLOGIES” section of this Policy. The legal basis of this processing
        is your consent. You can withdraw your consent at any time by contacting
        the administrator whose contact information appear at the bottom of this
        Policy. In addition, be assured that we do not associate any cookies
        identifier or similar technologies to information pertaining to your
        racial or ethnic origin, your political opinions, your religious or
        philosophical beliefs or your syndical affiliations, your health, your
        sexual life, or your sexual orientation nor your genetic or biometric
        data which may facilitate your identification in a unique manner.
      </P>

      <H6>Log files</H6>
      <P>
        We save the log files on the Service’s servers which contain some data
        such as your IP address, the date and time of your use of the Service,
        the cookies identifying your browser and its language, as well as
        various request to the servers and their responses. These files may
        constitute personal Data about you.
      </P>

      <H6>Purposes and legal basis of the processing</H6>
      <P>
        We process log files pertaining to your use of the Service to understand
        origin of an error or a bug in the Service and to establish Service
        connection statistics. The legal basis of this processing is our
        legitimate interest to reduce the number of interruptions and failures
        of the Service during your use of it as much as possible.
      </P>

      <H6>Your devices’ data</H6>
      <P>
        We collect data on the devices with which you access the Service, such
        as the unique ID of the device, and information from the device’s
        captors (camera, microphones, accelerometers, gyroscopes, compasses,
        etc.). This data may constitute personal Data about you.
      </P>

      <H6>Purposes and legal basis of the processing</H6>
      <P>
        We process the data from the devices with which you access the Service
        to ensure the cohesion of the Service on all your devises supporting the
        Service. The legal basis of this processing is our legitimate interest
        for the Service to be accessible in a coherent manner on as many devices
        that you own as possible.
      </P>

      <H5>2. THE CATEGORIES OF RECIPIENTS OF YOUR PERSONAL DATA</H5>
      <P>
        Except for the cases prescribed by the law or those expressly prescribed
        in this Policy, we never disclose your personal Data to a third party.
      </P>

      <H6>Service providers</H6>
      <P>
        We may provide some of your personal Data to third parties for them to
        use them within the framework of their internal commercial functions
        (for example, software development firms, customer service, maintenance,
        security, data analysis, email expedition, beta tests or data hosting)
        on your behalf. In addition, some third-party service providers may
        collect data, including personal Data on your behalf. These service
        providers committed to comply with the applicable laws regarding your
        personal Data as well as this Policy. We will only provide these
        providers with the personal Data they need to provide their services and
        they are forbidden from using this personal Data for another purpose.
      </P>

      <H6>Legal requirements</H6>
      <P>
        We may disclose your personal Data if we deem in good faith that this
        measure is required by summons, a mandate or any other legal or
        administrative decision rendered in compliance with the law. We may also
        disclose personal Data if we deem in good faith that this measure is
        appropriate or necessary to avoid a breach of our modalities or terms of
        use, our user licenses agreements or any other agreement you are a part
        of; to protect ourselves from a claim; to protect our rights, our
        property, our safety or that of a partner, a person or the public; to
        maintain and ensure the safety and integrity of the Service or of our
        infrastructures regarding an abusive or illegal use; to defend ourselves
        against claims or allegations of a third party; or to collaborate with
        the governmental regulatory agencies who have jurisdiction.
      </P>

      <H6>Property transfer</H6>
      <P>
        The data about our users, including the personal Data may be disclosed
        within the framework of a bankruptcy, a merger, the sale or transfer of
        the activities linked to the Service, an acquisition or a similar
        transaction. In the eventuality of such a transaction during which your
        personal Data shall be transferred to a third party, we will make
        reasonable efforts to notify you. For example, we will publish a notice
        of transfer of personal Data on the Service and, if we have your email
        address, we will send a notice of transfer of your personal Data to this
        address. In addition, we will require from the third party receiving
        your personal Data in such a framework that they agree to protect the
        confidentiality of your personal Data in manner in compliance with this
        Policy and that they respect the applicable laws in matters of personal
        Data. They must also commit to only process your personal Data in
        compliance with this Policy unless they notify beforehand, and when
        required by the law, by obtaining your consent beforehand.
      </P>

      <H6>Other cases</H6>
      <P>
        We may transmit your personal Data to third parties if: i) we obtained
        your consent to do so, ii) to our legal advisors or others, if they are
        subject to confidentiality obligations at least as strict as those
        prescribed by this policy and that they comply with the applicable laws
        in matters of personal Data.
      </P>

      <H5>3. SECURITY OF YOUR PERSONAL DATA</H5>
      <P>
        We take considerable measures, including the implementation and
        application of physical, electronic, and administrative procedures, to
        ensure the security, the integrity and the accuracy of all of the
        personal Data collected. Our measures include procedures designed to
        avoid the non-authorized access, the modification, the abusive use or
        the disclosure of personal Data. In the eventuality of a breach in the
        security systems, we may attempt to send you a notice by Emil to allow
        you to take the necessary protection measures.
      </P>
      <P>
        Despite what precedes, the data, including emails and internet
        communications, the network communications, telephone communications or
        any other electronic mean may be intercepted illicitly by unauthorized
        third parties. We cannot guarantee an absolute efficiency and/or
        security of the Service. Through diverted and illicit means, it is for
        instance possible for a hacker to succeed in entering into the Service’s
        servers. It is therefore important to keep in mind, before using the
        functionalities offered by the Service, that it is always possible for a
        malevolent individual to access the Service’s servers and use for their
        own purposes, the data you disclosed on or via the latter.
      </P>

      <H5>4. STORAGE OF YOUR PERSONAL DATA</H5>
      <P>
        We store the personal Data only for the duration required to be able to
        continue our commercial activities in a viable manner or according to
        what we deem to be legally required. More precisely, for as long as you
        keep your account, we will keep the personal Data which are requested
        from you for a duration of five (5) years following your last connection
        to the Service.
      </P>

      <H5>5. CONSENT</H5>
      <P>
        Before providing us any personal Data for a third party, including the
        Beneficiaries, you acknowledge having obtained the consent of the person
        who this personal Data pertains to, to provide them.
      </P>
      <P>
        By providing us with this personal Data, you agree that we may collect
        or use this personal Data in compliance with this Policy and according
        to the preferences in matter of confidentiality protection that you
        specified, when applicable, and as authorized or required by the law.
      </P>
      <P>
        Subject to legal and contractual requirements, you may refuse or
        withdraw your consent regarding some of the purposes determined at any
        time by contacting us. If you refuse or withdraw your consent, it is
        possible that we may not be able to provide or continue to provide some
        services or information which may be useful to you.
      </P>
      ...
      <P>
        Cookies are text files containing small quantities of information
        downloaded on your device when you visit a website. The cookies are then
        transferred to the original Website upon each following visit, or on
        another website which recognizes this cookie. Cookies are useful,
        because they allow a Website to recognize a user’s device. You can
        always find information regarding the cookies on allaboutcookies.org.
      </P>
      <P>
        The cookies have several different functions, like allowing you to
        browse between pages efficiently, save your preferences and improve the
        user experience. They may also ensure that the advertisements you see
        online are more pertinent to you and your interests. Our server installs
        a permanent cookie on your devices during your first visit and,
        depending on the applications used, other permanent or temporary cookies
        may be used to technically manage some choices you make. Rest assured
        that no personal Data is kept as such in the cookies.
      </P>

      <H6>Choosing to not authorize cookies</H6>
      <P>
        You can set up your browser for it to notify you when you receive a
        cookie, therefore allowing you to decide if you wish to accept it or
        not.
      </P>

      <H5>7. INTERNET PROTOCOL ADDRESS</H5>
      <P>
        The internet protocol address (IP address) is associated to your
        device’s internet connection by your internet access provider. We may
        use this IP address to, notably, diagnose issues with its web servers,
        manage the Service and compile statistics.
      </P>
      ...
      <P>
        Generally, we commit to inform any person requesting it of the existence
        of personal Data pertaining to them, of the use of it and of the fact,
        when applicable, that they are provided to third parties, and allow them
        to consult them. It will be possible to contest the accuracy and
        integrality of the information and to make appropriate corrections.
      </P>
      <P>
        Please note that the access to your file containing your personal Data
        is free However, we may require the cost of the reasonable fees linked
        to the physical reproduction and the transmission of this personal Data.
        If that is the case, we will inform you of these costs beforehand.
      </P>
      <P>
        Without limiting the generality of what precedes, you have the right to
        receive the personal Data pertaining to you and that you provided us, in
        a structured format, commonly used and machine readable, you have the
        right to transmit this personal Data to another person in charge of the
        processing without us standing in the way, when i) the processing is
        founded on your consent or a contract concluded between you and us and
        ii) the processing is done through automated processes. In addition,
        when it is technically possible, you may obtain for this personal Data
        to be directly transmitted by us to your new person in charge of the
        processing.
      </P>

      <H6>Accuracy of your personal data and right to right to be forgotten</H6>
      <P>
        The personal Data that you disclose to us must be as complete, accurate
        and up to date as required by the purposes for which they are destined.
        You are allowed to get them modified in your file to correct inaccurate,
        incomplete or equivoque data and to delete an expired or unjustified
        data for the subject of the file. Most of your personal Data may be
        consulted and corrected by connecting to your account and accessing your
        profile. Otherwise, we invite you to contact the administrator whose
        contact information is located at the end of this Policy to request for
        them to do it. Without limiting the generality of what precedes, you
        have, at any time, the right to request, except in some circumstances
        prescribed by the law, the deletion of your personal Data if: i) it is
        no longer necessary in regard to the purposes for which they were
        collected or processed in another manner; ii) we obtained from you the
        consent to the processing of this personal Data and there is no other
        legal basis to the processing; iii) you oppose the processing without us
        having a legitimate imperious reason for the processing; iv) this
        personal data is the subject of an illicit processing; or v) they must
        be deleted to comply with a legal obligation prescribed by the
        applicable law.
      </P>

      <H6>
        Limitation of the processing or the right to oppose to the processing
      </H6>
      <P>
        You have, at any time, the right, in some circumstances prescribed by
        the applicable legislation, to request for the administrator whose
        contact information is located at the end of this Policy to limit some
        processing we make of your personal Data or to oppose to their
        processing.
      </P>

      <H6>Notifications, complaints and communication</H6>
      <P>
        Through the publication of this Policy, we make precise information
        about our policies and practices regarding the management of personal
        Data to anyone. If you have questions pertaining to this Policy, do not
        hesitate to contact the administrator who is responsible for the Policy
        and can be contacted at the address mentioned at the end of this Policy,
        for us to be able to reply if possible. We reserve the right to ask you
        for some information to identify you.
      </P>
      <P>
        In case of non-compliance with the principles listed in this Policy, you
        may address a complaint by contacting the administrator whose contact
        information is below. Depending on your jurisdiction (ex: Canada), you
        can also make a complaint with a control authority
      </P>

      <H5>9. MODIFICATIONS OF THE POLICY</H5>
      <P>
        When we make, at our discretion, any changes to this Policy, we will
        modify the date of the “latest update” as found above.
      </P>

      <P>
        Although it is not our intention to frequently or substantially modify
        this Policy, it may happen that we do it to better serve you in the
        future or given the evolution of our offer of services, the technology,
        or the law. We invite you to review its content regularly to be notified
        of any change to the Policy. If the changes are substantial, we will
        send you a notification via the Service or via any other mean so you can
        take note of the modifications before continuing your use of the
        Service. If you disapprove of one or more modifications, you must stop
        using the Service. Your use of the Service after the display or the
        communication of such modifications will be considered as acceptation of
        the revised Policy.
      </P>

      <P>
        <b>
          For any question or comment regarding this Policy, please do not
